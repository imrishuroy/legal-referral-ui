  ...
  List<Widget>? listPagesViewModel = [
    Column(
      ...
      children: [
        ...
        const Text(
          'Effortlessly connect with attorneys across various practice areas '
          'spanning all states within the USA.',
        ),
        Row(
          children: [
    ...
    Column(
      ...
      children: [
        ...
        const Text(
          'Stay up to date with the latest developments in the legal '
          'landscape, news and updates to your field',
        ),
        Row(
          children: [
            Expanded(child: CustomButton(onTap: () {}, text: 'LOG IN')),
    ...
    Column(
      ...
      children: [
        ...
        const Text(
          'Obtain trusted referrals from an extensive network of attorneys '
          'spanning every region of the USA',
        ),
        Row(
          children: [
            Expanded(child: CustomButton(onTap: () {}, text: 'LOG IN')),
