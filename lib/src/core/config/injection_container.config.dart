...
import '../../features/auth/presentation/bloc/auth_bloc.dart' as _i46;
import '../../features/auth/presentation/presentation.dart' as _i51;
...
import '../../features/feed/presentation/bloc/feed_bloc.dart' as _i55;
...
import '../../features/network/domain/usecases/network_usecase.dart' as _i45;
...
import '../../features/post/presentation/bloc/post_bloc.dart' as _i52;
...
import '../../features/referral/domain/usecases/referral_usecases.dart' as _i49;
...
import '../../features/search/data/repositories/search_repository_impl.dart'
    as _i35;
import '../../features/search/domain/domain.dart' as _i48;
import '../../features/search/domain/repositories/search_repository.dart'
    as _i34;
import '../../features/search/domain/usecases/search_usecase.dart' as _i47;
...
import '../../features/wizard/domain/usecases/wizard_usecase.dart' as _i44;
import '../../features/wizard/presentation/bloc/wizard_bloc.dart' as _i53;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i44.WizardUseCase>(() =>
        _i44.WizardUseCase(wizardRepository: gh<_i14.WizardRepository>()));
    gh.lazySingleton<_i45.NetworkUseCase>(() =>
        _i45.NetworkUseCase(networkRepository: gh<_i16.NetworkRepository>()));
    gh.lazySingleton<_i46.AuthBloc>(
        () => _i46.AuthBloc(authUseCase: gh<_i39.AuthUseCase>()));
    gh.lazySingleton<_i47.SearchUseCase>(() =>
        _i47.SearchUseCase(searchRepository: gh<_i48.SearchRepository>()));
    gh.lazySingleton<_i49.ReferralUseCases>(() => _i49.ReferralUseCases(
        referralRepository: gh<_i22.ReferralRepository>()));
    gh.factory<_i50.ChatBloc>(() => _i50.ChatBloc(
          authBloc: gh<_i51.AuthBloc>(),
          networkUseCase: gh<_i16.NetworkUseCase>(),
          chatUseCase: gh<_i28.ChatUseCase>(),
        ));
    gh.factory<_i52.PostBloc>(
        () => _i52.PostBloc(postUsecase: gh<_i25.PostUsecase>()));
    gh.factory<_i53.WizardBloc>(
        () => _i53.WizardBloc(wizardUseCase: gh<_i44.WizardUseCase>()));
    gh.factory<_i54.ProfileBloc>(() => _i54.ProfileBloc(
          authBloc: gh<_i51.AuthBloc>(),
          profileUseCase: gh<_i43.ProfileUseCase>(),
        ));
    gh.singleton<_i55.FeedBloc>(() => _i55.FeedBloc(
    ...
    gh.factory<_i57.SearchBloc>(
        () => _i57.SearchBloc(searchUseCase: gh<_i48.SearchUseCase>()));
